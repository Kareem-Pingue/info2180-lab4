...
document.addEventListener('DOMContentLoaded', function()
{
    ...
    {
        event.preventDefault(), httpR = new XMLHttpRequest();      
        httpR.onreadystatechange = function()
        {
            if (httpR.readyState === XMLHttpRequest.DONE && httpR.status === 200)
            {
                var r = httpR.responseText; var key = document.getElementById("search-box").value; document.getElementById("result").innerHTML = r;
            }
